...
import { addproperty, listproperty, removeproperty, updateproperty, singleproperty, removeAllProperties } from '../controller/productController.js';
...
propertyrouter.post('/remove-all', removeAllProperties);
